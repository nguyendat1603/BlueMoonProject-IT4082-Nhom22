...
public class Home_list implements Initializable {
    ...
    @FXML
    private Label labelHienThiKetQuaTaiKhoan;
    ...
    private void updateTaiKhoanKetQuaLabel() {
        if (labelHienThiKetQuaTaiKhoan != null && filteredTaiKhoanList != null) {
            labelHienThiKetQuaTaiKhoan.setText("Hiển thị " + filteredTaiKhoanList.size() + " tài khoản");
        }
    }
